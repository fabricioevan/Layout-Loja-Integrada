...
$(document).ready(function() {
    ...
    // Minha conta
        ...
        var usernometrat = usernome.replace('OlÃƒÂ¡, ', '');
        
        
        
        if($('.novo-login .btn-group').length ){
            $('.novo-conta').append('<div class="dir"><div class="conta-inside"><div class="conta-esq-inside"><ul class="conta-esq"><li class="user-logo-inside"><span class="user-logo"><span class="user-logo-fora"><i class="fas fa-user"></i></span></span><span class="user-logo-nome"><span class="user-bv-1">OlÃƒÂ¡,</span><strong class="user-bv-2">'+usernometrat+'</strong></span><span class="user-logo-sair"><a href="/conta/logout">Sair</a></span></li><li class="user-logo-conta"><a href="/conta/index" class="botao grande principal">Minha Conta</a></li></ul></div><div class="conta-dir-inside"><ul class="conta-dir"><li class="conta-config login-itens"><a href="/conta/editar"><strong><i class="fas fa-cog"></i> Meus Dados</strong></a></li><li class="conta-pedidos login-itens"><a href="/conta/pedido/listar"><strong><i class="fas fa-archive"></i> Meus Pedidos</strong></a></li><li class="conta-favoritos login-itens"><a href="/conta/favorito/listar"><strong><i class="fas fa-heart"></i> Lista de Desejos</strong></a></li></ul></div></div></div>');
            
        }else{
            $('.novo-conta').append('<div class="dir"><div class="conta-inside"><div class="conta-esq-inside"><ul class="conta-esq"><li class="user-logo-inside"><span class="user-logo"><span class="user-logo-fora"><i class="fas fa-user"></i></span></span><span class="user-logo-nome"><span class="user-bv-1">OlÃƒÂ¡,</span><strong class="user-bv-2">Bem-vindo!</strong></span></li><li class="user-logo-conta"><a href="/conta/index" class="botao grande principal">Minha Conta</a></li></ul></div><div class="conta-dir-inside"><ul class="conta-dir"><li class="conta-cadastro login-itens"><a href="/conta/login"><strong><i class="fas fa-plus-circle"></i> Cadastrar</strong></a></li><li class="conta-login login-itens"><a href="/conta/login"><strong><i class="fas fa-user"></i> Entrar</strong></a></li><li class="conta-pedidos login-itens"><a href="/conta/login?next=/conta/pedido/listar"><strong><i class="fas fa-archive"></i> Meus Pedidos</strong></a></li></ul></div></div></div>');
    ...
    //
        ...
        function updateText(){
            ...
            if($avista.length){ 
                $.each( $avista, function(){
                    ...
                    $(this).html( $(this).html().replace('via Boleto BancÃƒÂ¡rio', '<span>'+textoBoleto+'</span>') );
                    $(this).html( $(this).html().replace('via DepÃƒÂ³sito', '<span>'+textoDeposito+'</span>') );
                });
            }    
        }
        updateText();
        ...
        $('.listagem-item .preco-produto .titulo:contains("PreÃƒÂ§o sob consulta")').parent().addClass('nova-consulta');
...
if (typeof instagram !== 'undefined') {
    ...
    // Rodape
        ...
        $('.logos-creditos').prepend('<a href="https://api.whatsapp.com/send?phone=5561920006584" target="_blank" class="logo-agencia"><small>Desenvolvimento:</small><img src="https://cdn.awsli.com.br/874/874293/arquivos/foxrod2.png"></a>');
    ...
    if ($(window).width() <= 767) {
     ...
     // Rastreio Rapido
        ...
        $('.conta-inside .conta-dir').append('<li class="conta-rastreio login-itens"><span><strong><i class="fas fa-truck"></i> Rastrear Pedido</strong><div class="rastreio"><div class="campo-rastreio"><input type="text" placeholder="Digite seu cÃƒÂ³digo" id="input-rastreio"><button onclick="rastreioRapido()" class="botao grande principal"><i class="fas fa-angle-right"></i></button></div></div></span></li>');
